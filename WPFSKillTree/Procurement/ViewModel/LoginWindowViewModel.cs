...
namespace Procurement.ViewModel
{
    public class LoginWindowViewModel : INotifyPropertyChanged
    {
        ...
        public LoginWindowViewModel(UserControl view)
        {
            ...
            this.passwordChanged = string.IsNullOrEmpty(Settings.UserSettings["AccountPassword"]);
            ...
            ApplicationState.InitializeFont(POESKillTree.Properties.Resources.fontin_regular_webfont);
            ApplicationState.InitializeFont(POESKillTree.Properties.Resources.fontin_smallcaps_webfont);
        }
        ...
        public void Login(bool offline)
        {
            ...
            {
                SecureString password = passwordChanged ? this.view.txtPassword.SecurePassword : Settings.UserSettings["AccountPassword"].Decrypt();
        ...
        {
            Settings.UserSettings["AccountLogin"] = Email; //my modification to fix some problems
            if (passwordChanged && !string.IsNullOrEmpty(Settings.UserSettings["AccountPassword"]))
