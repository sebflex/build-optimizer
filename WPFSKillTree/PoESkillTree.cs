...
namespace PoEClasses
{
    ...
    internal class Node
    {
        ...
        public string dn { get; set; } //name
        
        public bool m { get; set; } //mastery
        ...
        public int o { get; set; } //orbit
        
        public int oidx { get; set; } //orbitIndex
        ...
        [JsonProperty("out")]
        public List<int> ot { get; set; } //link id
    }

    internal class Constants
    {

        public Dictionary<string, int> classes { get; set; } //map between a class name and a number {[StrClass, 1]}
        
        public Dictionary<string, int> characterAttributes { get; set; } //map between attribute name and a number {[Strength, 0]}
